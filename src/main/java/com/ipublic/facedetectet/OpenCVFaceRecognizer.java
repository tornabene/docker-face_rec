...
public class OpenCVFaceRecognizer {
    public static void main(String[] args) {
    	...
    	String trainingDir = "~/git/docker-face_rec/src/main/resources/";
		String fileImage = "~/git/docker-face_rec/src/main/resources/jessica_1.jpg";
		
        Mat testImage = imread( fileImage , CV_LOAD_IMAGE_GRAYSCALE);
